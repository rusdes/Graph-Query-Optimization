 ...
 * them, element wise. A
 * Map function always produces a single result element for each input element.
 * Typical applications
 * are parsing elements, converting data types, or projecting out fields.
 * Operations that produce
 * multiple result elements from a single input element can be implemented using
 * the {@link
 * FlatMapFunction}.
 *
 * <p>
