 ...
 *
 * <p>
 * Classes, methods and fields with this annotation are stable across minor
 * releases (1.0, 1.1,
 * 1.2). In other words, applications using @Public annotated classes will
 * compile against newer
