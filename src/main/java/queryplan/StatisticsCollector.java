...
public class StatisticsCollector {
	...
	// This function will write a three-column file to the target directory. The
	// three column consists of the vertex label names, the number of the vertices
	// and the proportion.
	public void getVerticesStats() throws Exception {
		List<Triplet<Long, String, String>> verticesFromFile = readVerticesLineByLine(
				Paths.get(srcDir, "vertices.csv"));
